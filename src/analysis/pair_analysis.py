...
class PairAnalysis:
    ...
    def __init__(self, tickers, threshold=THRESHOLD, pvalue=PVALUE):
    ...
    def potential_pairs(self):
        ...
        if not self.pair_info:
            self.error_handler.handle_error('corr', self.threshold, coefficients)
    ...
    def cointegration_test(self):
        ...
        if valid_pairs == 0:
            self.error_handler.handle_error('coint', self.pvalue, self.pair_info)
